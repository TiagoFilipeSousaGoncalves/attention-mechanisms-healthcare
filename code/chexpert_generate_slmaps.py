...
for model_name in MODEL_NAMES:
    ...
    for batch_idx, (images, labels) in enumerate(test_loader):
        ...
        # Baseline
        baseline_weights = os.path.join(weights_dir, f"{model_name.lower()}_baseline_val_chexpert.pt")
        model.to(DEVICE)
        ...
        baselinedaug_weigths = os.path.join(weights_dir, f"{model_name.lower()}_baselinedaug_val_chexpert.pt")
        model.to(DEVICE)
        ...
        # MLDAM
        mldam_weights = os.path.join(weights_dir, f"{model_name.lower()}_mldam_val_chexpert.pt")
        ...
        mldamdaug_weigths = os.path.join(weights_dir, f"{model_name.lower()}_mldamdaug_val_chexpert.pt")
        mldam_model.to(DEVICE)
