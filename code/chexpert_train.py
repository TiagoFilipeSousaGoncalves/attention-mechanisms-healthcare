...
# Results and Weights
weights_dir = os.path.join("results", "chexpert", "weights")
...
# Train Dataset
train_set = TorchDatasetFromPickle(
    base_data_path = train_dir, 
    pickle_path = os.path.join(train_dir, "Annotations.pickle"), 
...
# Validation Dataset
val_set = TorchDatasetFromPickle(
    base_data_path = val_dir,
    pickle_path = os.path.join(val_dir, "Annotations.pickle"),
...
for epoch in range(EPOCHS):
    ...
    if avg_train_loss < min_train_loss:
        ...
        # Save checkpoint
        model_path = os.path.join(weights_dir, f"{MODEL_NAME.lower()}_baseline_tr_chexpert.pt")
    ...
    with torch.no_grad():
        ...
        if avg_val_loss < min_val_loss:
            ...
            # Save checkpoint
            model_path = os.path.join(weights_dir, f"{MODEL_NAME.lower()}_baseline_val_chexpert.pt")
            torch.save(model.state_dict(), model_path)
